...
class InverseKinematics(Node):
    ...
    def forward_kinematics(self, q):
        ...
        x = 2*np.cos(q1) + 1.5*np.cos(q1 + q2) + 0.8*np.cos(q1 + q2 + q3)
        y = 2*np.sin(q1) + 1.5*np.sin(q1 + q2) + 0.8*np.sin(q1 + q2 + q3)
        z = 0
    ...
    def jacobian(self, q):
        ...
        j11 = -2*np.sin(q1) - 1.5*np.sin(q1 + q2) - 0.8*np.sin(q1 + q2 + q3)
        j12 = -1.5*np.sin(q1 + q2) - 0.8*np.sin(q1 + q2 + q3)
        j13 = -0.8 * np.sin(q1 + q2 + q3)
        j21 =  2*np.cos(q1) + 1.5*np.cos(q1 + q2) + 0.8*np.cos(q1 + q2 + q3)
